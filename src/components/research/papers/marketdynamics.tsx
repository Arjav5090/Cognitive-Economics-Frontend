...
export default function MarketDynamicsPage() {
          ...
          <div >
            <section className="space-y-4 font-outfit">
              <p className="text-[#000000] text-justify font-normal leading-relaxed">
                ...
                these dynamics might underlie market crashes (<i className="font-light">"Business as
                Usual, Market Crashes, and Wisdom after the Fact"</i> ). While I
                hoped this would spark efforts to measure gaps between firm
                knowledge and actions, progress has been limited. Over the last
                30 years, my work has continued to focus on the challenges of
                identifying informational constraints and their impact on market
                dynamics.
              </p>
            </section>
  ...
  <ol className="list-decimal pl-4 text-[#000000] space-y-3 font-outfit text-justify">
    <li>
      Caplin, A., and J. Leahy, <strong>“Business as Usual, Market Crashes, and Wisdom after the Fact”.</strong>
      <i className="font-light"> American Economic Review, 548-565, 1994.</i>
      <p>
    ...
    <li>
      Caplin, A., J. Leahy, and F. Matˇejka, <strong>“Social Learning and Selective Attention”.</strong>
    ...
    <li>
      Caplin, A., and J. Leahy, <strong>“Miracle on Sixth Avenue”.</strong>
    ...
    <li>
      Caplin, A., and J. Leahy, <strong>“Sectoral Shocks, Learning, and Aggregate Fluctuations”.</strong>
      <i className="font-light"> Review of Economic Studies, 777-794, 1993.</i>
      <p>
