...
export default function DataEngineeringCognitiveEconomicsPage() {
  return (
    <main className="flex flex-col items-center justify-center px-4 py-6">
      <Helmet>
        <title>Data Engineering for Cognitive Economics</title>
        <meta
          name="description"
          content="Explore how cognitive economics integrates data engineering, stochastic choice, and economic surveys to enhance decision-making models."
        />
        <meta
          property="og:title"
          content="Data Engineering for Cognitive Economics"
        />
        <meta
          property="og:description"
          content="Learn about state-dependent stochastic choice, choice process protocols, and new economic data methods."
        />
        <meta
          property="og:url"
          content="https://andrewcaplin.com/research/papers/cognitive-data-engineering"
        />
         <link rel="canonical" href="https://andrewcaplin.com/research/papers/cognitive-data-engineering" />
      </Helmet>
            ...
            <section>
              ...
              <ol className="list-decimal pl-4 text-[#000000] space-y-3 font-outfit text-justify">
                <li>
                  ...
                  <strong>
                    <a
                      href="https://www.jstor.org/stable/2696443"
                      target="_blank"
                ...
                <li>
                  ...
                  <strong>
                    <a
                      href="https://academic.oup.com/book/2119/chapter-abstract/142058523?redirectedFrom=fulltext"
                      target="_blank"
                      className="hover:underline"
                    >
                ...
                <li>
                  ...
                  <strong>
                    <a
                      href="https://link.springer.com/chapter/10.1007/978-94-010-9276-0_8"
                      target="_blank"
                      className="hover:underline"
                    >
                ...
                <li>
                  ...
                  <strong>
                    <a
                      href="https://pubs.aeaweb.org/doi/10.1257/aer.101.7.2899"
                      target="_blank"
                      className="hover:underline"
                    >
                ...
                <li>
                  ...
                  <strong>
                    <a
                      href="https://link.springer.com/article/10.1007/s40881-015-0003-5"
                      target="_blank"
                      className="hover:underline"
                    >
                ...
                <li>
                  ...
                  <strong>
                    <a
                      href="https://onlinelibrary.wiley.com/doi/10.1111/ecin.12294"
                      target="_blank"
                      className="hover:underline"
                    >
                ...
                <li>
                  ...
                  <strong>
                    <a
                      href="https://shs.cairn.info/revue-economique-2017-5-page-747?lang=fr"
                      target="_blank"
                      className="hover:underline"
                    >
                ...
                <li>
                  ...
                  <strong>
                    <a
                      href="https://www.nber.org/papers/w32587"
                      target="_blank"
                      className="hover:underline"
                    >
