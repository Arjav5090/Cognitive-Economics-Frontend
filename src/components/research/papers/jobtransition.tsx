          ...
          <div className="font-outfit">
            <section className="space-y-4">
              <p className="text-[#000000] text-justify font-outfit font-normal leading-relaxed">
                ...
                as a <i className="font-light">factor of production</i>{" "}
                alongside land and capital, with a production function
                summarizing the efficient transformation of inputs into outputs.
                This approach yields insights into market equilibrium for wages
                and product prices by combining input costs, factor
                availability, and demand for final goods.
              </p>
              <p className="text-[#000000] text-justify font-outfit font-normal leading-relaxed">
              ...
              <p className="text-[#000000] text-justify font-outfit font-normal leading-relaxed">
                ...
                <i className="font-light"> cognitive skills</i> essential for
                adapting to technological change. Cognitive economics seeks to
                fill this gap by exploring the durable skills workers need to
                thrive in future labor markets, especially as AI takes over many
