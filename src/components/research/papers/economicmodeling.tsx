  ...
  return (
    <main className="flex flex-col items-center justify-center px-4 py-6">
      <Helmet>
        ...
        <meta
          name="description"
          content="Explore how cognitive economics integrates rational inattention theory, state-dependent stochastic choice, and cognitive economic modeling to improve decision-making frameworks."
        />
        <meta
          property="og:title"
          content="Cognitive Economic Modeling and Rational Inattention Theory"
        />
        <meta
          property="og:description"
          content="Learn about cognitive economic modeling, rational inattention, and their applications in decision-making and economic data engineering."
        />
        <meta
          property="og:url"
          content="https://andrewcaplin.com/research/papers/cognitive-economic-modeling-and-rational-inattention-theory"
        />
        <meta
          name="keywords"
          content="Cognitive Economics, Rational Inattention, Economic Modeling, Stochastic Choice, Bayesian Learning, Economic Theory"
        />
        <meta name="author" content="Andrew Caplin" />
        <meta property="og:type" content="article" />
        <link rel="canonical" href="https://andrewcaplin.com/research/papers/cognitive-economic-modeling-and-rational-inattention-theory" />
      </Helmet>
