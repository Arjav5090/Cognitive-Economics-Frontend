...
export default function StateDependenceMonetaryPolicyPage() {
  ...
  <li>
    Caplin, A.,{" "}
    <strong>
      <a href="https://www.jstor.org/stable/1913214" target="_blank" rel="noopener noreferrer" className="hover:underline">
  ...
  <li>
    ...
    <strong>
      <a href="https://www.jstor.org/stable/1884277" target="_blank" rel="noopener noreferrer" className="hover:underline">
  ...
  <li>
    ...
    <strong>
      <a href="https://www.jstor.org/stable/2937923" target="_blank" rel="noopener noreferrer" className="hover:underline">
  ...
  <li>
    Caplin, A., and J. Leahy,{" "}
    <strong>
      <a href="https://www.jstor.org/stable/2118300" target="_blank" rel="noopener noreferrer" className="hover:underline">
  ...
  <li>
    Caplin, A., and J. Leahy,{" "}
    <strong>
      <a href="https://www.jstor.org/stable/2938239" target="_blank" rel="noopener noreferrer" className="hover:underline">
  ...
  <li>
    Caplin, A., and J. Leahy,{" "}
    <strong>
      <a href="https://www.sciencedirect.com/science/article/abs/pii/S0022053105000360#:~:text=Equilibrium%20models%20of%20durable%20goods,that%20of%20a%20monopoly%20producer" target="_blank" rel="noopener noreferrer" className="hover:underline">
  ...
  <li>
    Caplin, A., and J. Leahy,{" "}
    <strong>
      <a href="https://www.aeaweb.org/articles?id=10.1257/jep.24.1.183" target="_blank" rel="noopener noreferrer" className="hover:underline">
