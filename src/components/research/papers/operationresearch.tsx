...
export default function OperationsResearchPage() {
  return (
    <main className="flex flex-col items-center justify-center px-4 py-6 font-outfit">
      <Helmet>
        <title>Operations Research | Andrew Caplin</title>
        <meta
          name="description"
          content="Explore Andrew Caplin's research on operations research, including Scarf’s algorithm, integer programming, and markets for indivisible goods."
        />
        <meta
          property="og:title"
          content="Operations Research | Andrew Caplin"
        />
        <meta
          property="og:description"
          content="Delve into research on Scarf’s algorithm, graph-theoretic approaches to markets, and equilibrium analysis in operations research."
        />
        <meta
          property="og:url"
          content="https://andrewcaplin.com/research/papers/operations-research-research"
        />
        <meta
          name="keywords"
          content="Operations Research, Integer Programming, Scarf’s Algorithm, Graph Theory, Market Equilibrium, Indivisible Goods, Economic Theory"
        />
        <meta name="author" content="Andrew Caplin" />
        <meta property="og:type" content="article" />
        <link rel="canonical" href="https://andrewcaplin.com/research/papers/operations-research-research" />
      </Helmet>
            ...
            <section className="mt-4">
              ...
              <ol className="list-decimal pl-4 text-[#000000] space-y-2 font-outfit text-justify">
                <li>
                  ...
                  <strong>
                    <a
                      href="https://www.jstor.org/stable/3689638"
                      target="_blank"
