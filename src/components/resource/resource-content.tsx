...
export function ResourcesContent() {
  return (
    <div className="md:ml-20 p-4 md:p-8 max-w-4xl">
      <h1 className="text-4xl font-outfit font-bold mb-6">Introduction to Cognitive Economics</h1>
...
podcasts for those who prefer learning that way.
      ...
      <h2 className="text-2xl font-outfit font-bold mb-4">Foundations of Cognitive Economics</h2>
      <div className="prose font-light font-outfit max-w-none mb-8">
        <p>
