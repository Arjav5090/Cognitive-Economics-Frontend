...
const CalibrationandReferencesPage: React.FC = () => {
  ...
  <li>
    ...
    </Link>. Journal of Economic Theory, 2025.
    <p>
      Examines the alignment of machine learning predictions with cognitive economic models. The first
  ...
  <li>
    ...
    </Link>. NBER Working Paper 31674, 2023.
    <p>
      ...
      in decision-intensive occupations.
    </p>
  </li>
  <li>
    ...
    </Link>. NBER Working Paper, 2023.
    <p>
      Measures challenges in human-AI collaboration in radiology and proposes separation of cases into those
      that are best decided by a human expert and those that are better left to the AI.
    </p>
  </li>
  <li>
    Caplin, A., D. Deming, S. Li, D. Martin, P. Marx, B. Weidmann, and K. Ye,{" "}
    <Link
    ...
    </Link>. NBER Working Paper 33021, 2024.
    <p>
      Demonstrates that skill and belief calibration jointly determine the benefits of working with AI. AI
      assistance is most valuable for calibrated individuals with accurate self-assessments.
    </p>
  </li>
  <li>
    G. Epping, A. Caplin, E. Duhaime, W. Holmes, D. Martin, and J. Trueblood,{" "}
    <Link
    ...
    <p>
      Uses cognitive economic methods to improve AI labeling and AI performance in crowd-sourced datasets,
      by recalibrating subjective probability judgments.
    </p>
  </li>
</ul>
