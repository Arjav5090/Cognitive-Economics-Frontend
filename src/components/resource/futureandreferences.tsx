  ...
  return (
    <div className="p-6 sm:p-8 lg:p-12 max-w-5xl mx-auto font-outfit text-justify">
      ...
      <div className="prose max-w-none mb-8">
        ...
        <ul className="list-disc text-justify pl-6 space-y-2 font-outfit text-base sm:text-lg">
          <li>
            ...
            . Journal of Money, Credit and Banking, 496-516, 1997. Explains how
            falling property values prevent refinancing and quantifies the
            resulting economic damage in recession-hit states. It also proposes
            minor institutional changes to mitigate these effects.
          </li>
          <li>
            Caplin, A., C. Freeman and J. Tracy,{" "}
            <i>“Housing Partnerships: A New System of Housing Finance”</i>.
            Columbia University Discussion Paper 705, 1994. Proposes
            equity-based finance for residential housing.
          </li>
          <li>
            ...
            . MIT Press, 1997. Expands on equity-based finance, discussing its
            potential to expand affordability, and lower costs and risks while
            better aligning borrower and lender incentives to protect first-time
          ...
          <li>
            ...
            . Housing Policy Debate, vol. 18, 209-242, 2007. Evaluates equity
            sharing in the context of housing affordability using survey
            evidence.
          </li>
          <li>
            ...
            . Tax Law Review, 2008. Outlines IRS changes needed to clarify the
            tax status of shared equity mortgages.
          </li>
          <li>
            ...
            . American Economic Review Papers and Proceeding, 2014. Critiques
            the lack of policy accountability and the destructive role of the
            press in the 2006-2007 housing crisis.
          </li>
        </ul>
      </div>
