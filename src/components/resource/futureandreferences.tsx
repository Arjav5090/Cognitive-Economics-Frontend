...
const FutureandReferencesPage: React.FC = () => {
  ...
  <li>
    ...
    <p>
      Explains how falling property values prevent refinancing and quantifies the
      resulting economic damage in recession-hit states. It also proposes minor
      institutional changes to mitigate these effects.
    </p>
  </li>
  <li>
    Caplin, A., C. Freeman and J. Tracy,{" "}
  ...
  <li>
    ...
    . MIT Press, 1997.
    <p>
      Expands on equity-based finance, discussing its potential to expand
      affordability, and lower costs and risks while better aligning borrower and
      lender incentives to protect first-time buyers from exploitation.
    </p>
  </li>
  <li>
    ...
    <p>Evaluates equity sharing in the context of housing affordability using survey evidence.</p>
  </li>
  <li>
    ...
    . Tax Law Review, 2008.
    <p>Outlines IRS changes needed to clarify the tax status of shared equity mortgages.</p>
  </li>
  <li>
    ...
    <p>Critiques the lack of policy accountability and the destructive role of the press in the 2006-2007 housing crisis.</p>
  </li>
</ul>
